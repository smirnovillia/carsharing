package com.itacademy.jd2.is.carsharing.web.tag;
...
public class SortLink extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        if (listDto == null) {
            throw new IllegalArgumentException("context should have required attribute in session:" + ListDTO.LIST_MODEL_ATTRIBUTE);
        }
