...
<div class="row">
    <form:form class="col s12" method="POST" action="${pagesCar}/add" modelAttribute="formModel">
        ...
        <div class="row">
            <div class="col s12 center">
                ...
                <a class="btn waves-effect waves-light" href="${pagesCar}">back<i class="material-icons right"></i>
                </a>
            </div>
        </div>
    </form:form>
